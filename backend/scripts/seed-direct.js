...
console.log('🌱 Zipo Ecommerce Seed Data - Manual Creation');
console.log('============================================');
console.log('');
console.log('📚 Categories to create manually:');
